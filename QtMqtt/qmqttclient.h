...
public:
  enum TransportType { IODevice = 0, AbstractSocket, SecureSocket };
...
private:
  ...
  Q_PROPERTY(quint16 keepAlive READ keepAlive WRITE setKeepAlive NOTIFY
                 keepAliveChanged)
  Q_PROPERTY(ProtocolVersion protocolVersion READ protocolVersion WRITE
                 setProtocolVersion NOTIFY protocolVersionChanged)
  ...
  Q_PROPERTY(bool cleanSession READ cleanSession WRITE setCleanSession NOTIFY
                 cleanSessionChanged)
  Q_PROPERTY(QString willTopic READ willTopic WRITE setWillTopic NOTIFY
                 willTopicChanged)
  Q_PROPERTY(QByteArray willMessage READ willMessage WRITE setWillMessage NOTIFY
                 willMessageChanged)
  Q_PROPERTY(quint8 willQoS READ willQoS WRITE setWillQoS NOTIFY willQoSChanged)
  Q_PROPERTY(bool willRetain READ willRetain WRITE setWillRetain NOTIFY
                 willRetainChanged)
public:
  ...
  void unsubscribe(const QMqttTopicFilter &topic,
                   const QMqttUnsubscriptionProperties &properties);

  Q_INVOKABLE qint32 publish(const QMqttTopicName &topic,
...
#ifndef QT_NO_SSL
  Q_INVOKABLE void
  connectToHostEncrypted(const QString &sslPeerName = QString());
#endif
...
Q_SIGNALS:
  ...
  void messageStatusChanged(qint32 id, QMqtt::MessageStatus s,
